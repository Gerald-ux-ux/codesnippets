...
function ProductDemo(props: Props) {
  return (
    <div className="h-[30rem] w-full  bg-primary  bg-grid-white/[0.2]  relative flex items-center justify-center">
      ...
      <span className="text-2xl  flex flex-col gap-8 sm:text-4xl mx-auto px-8  font-bold relative z-20 bg-clip-text text-transparent  bg-gradient-to-b from-neutral-100 to-neutral-500 py-8">
